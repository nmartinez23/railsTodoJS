$(function() {
  ...
  // toggleTask takes an HTML representation of event that fires from HTML representation of toggle checkbox and performs API request to toggle value of 'done' field
